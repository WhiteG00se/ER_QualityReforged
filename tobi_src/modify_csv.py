...
def check_and_fix_trailing_comma_in_header(file_path):
...
check_and_fix_trailing_comma_in_header(input_csv_accessory)
...
check_and_fix_trailing_comma_in_header(input_csv_goods)
...
check_and_fix_trailing_comma_in_header(input_csv_protector)
...
check_and_fix_trailing_comma_in_header(input_csv_weapon)
...
check_and_fix_trailing_comma_in_header(input_csv_shop)
